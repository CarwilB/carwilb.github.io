...
This article draws on data provided by the Bolivian Instituto Nacional de Estadística ([website](https://www.ine.gob.bo/)\|Wikipedia) based on the 2024 Census, officially the Censo de Población y Vivienda 2024, which is [described in Spanish here](https://cpv2024.ine.gob.bo/index.php/censo-2024/). Data from the Census is published online in both tabulated and microdata (one-person, one-line, without names) format. To examine responses across multiple questions, I had to use the microdata, which is supplied as a \~3 GB comma-separate values (CSV) file with 11,365,333 rows × 118 columns. Working in the R programming language, I used the `arrow` package to query it without loading it into memory.
